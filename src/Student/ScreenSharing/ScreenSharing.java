...
public class ScreenSharing {
    ...
    public ScreenSharing() throws IOException {
    ...
    public void startReceivingScreen(String TeacherMulticastPort) {
        Constants.StartedSessionDetails.setTeacherIpAddress(TeacherMulticastPort);
    ...
    public void findMultiCastPort() {
        ...
        while (true) {
            try {
                ServerSocket s = new ServerSocket(Constants.StartedSessionDetails.getStudentMulticastPort());
                System.out.println("Student multicast Address is:" + Constants.StartedSessionDetails.getStudentMulticastPort());
                s.close();
                break;
            } catch (Exception ex) {
                Constants.StartedSessionDetails.setStudentMulticastPort((Constants.StartedSessionDetails.getStudentMulticastPort()+1));
